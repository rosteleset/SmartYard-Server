...
> [!IMPORTANT]
> Use a minimal Ubuntu Server 24.04 (Noble Numbat) installation on a VM or bare-metal server. Run all installation
> commands as `root` (`sudo -i`) unless stated otherwise.
