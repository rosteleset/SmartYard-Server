...
cd /opt/rbt
git pull https://github.com/rosteleset/SmartYard-Server `git ls-remote --tags https://github.com/rosteleset/SmartYard-Server | awk "{print \$2;}" | cut -d "/" -f 3 | sort --version-sort --field-separator=. | tail -n 1` --force
