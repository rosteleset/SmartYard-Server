<?php
    ...
    abstract class domophone extends hw {
         ...
         */
        public function __construct(string $url, string $pass, int $port, bool $first_time = false) {
        ...
        public function ping(): bool {
            $errno = false;
            $errstr = '';
            $fp = @fsockopen($this->url, $this->port, $errno, $errstr, 1);
