    ...
    namespace api\cameras {
        ...
        class camera extends api {
            ...
            public static function POST($params) {
                ...
                $cameraId = $cameras->addCamera($params["enabled"], $params["model"], $params["url"], $params["stream"], $params["credentials"], $params["publish"], $params["flussonic"], $params["lat"], $params["lon"], $params["direction"], $params["angle"], $params["distance"], $params["common"], $params["comment"]);
