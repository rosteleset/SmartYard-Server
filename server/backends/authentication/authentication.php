            ...
            public function twoFa($token, $oneCode) {
                ...
                foreach ($keys as $key) {
                    ...
                    if ($oneCode) {
                        ...
                        return $ga->getQRCodeText(@$this->config["backends"]["authentication"]["two_fa_name"] ?: i18n("two_fa_name"), $secret, @$this->config["backends"]["authentication"]["two_fa_title"] ?: i18n("two_fa_title"));
                    }
                }
            }
        }
