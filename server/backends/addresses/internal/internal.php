                    ...
                    case "pgsql":
                        switch (@$this->config["backends"]["addresses"]["text_search_mode"]) {
                            ...
                            default:
                                ...
                                error_log("\n\n$search\n\n");
                                $query = "select * from (select *, ts_rank(to_tsvector('russian', house_full), to_tsquery(:search)) as similarity from addresses_houses) as t1 where similarity > 0 order by similarity desc limit 1001";
                                break;
                        }
                        break;
