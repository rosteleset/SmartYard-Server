...
//                "dvrStream" => $camera["dvrStream"],
     ...
     * @param string $id Zabbix "hostid"
     * @return void
     */
    private function disableHost(string $id):void
    {
        $now = time();
        $body = [
            'jsonrpc' => '2.0',
     ...
     * @return void
     */
    private function enableHost(string $id):void
    {
        $body = [
            'jsonrpc' => '2.0',
            'method' => 'host.update',
