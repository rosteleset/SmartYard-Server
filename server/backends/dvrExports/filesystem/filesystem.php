<?php
    ...
    {
        class filesystem extends dvrExports
        {
            /**
             * @inheritDoc
             */
            ...
            public function runDownloadRecordTask($recordId)
            {
                ...
                try {
                    ...
                    if ($task) {
                        $dvr_files_path = @$config["backends"]["dvrExports"]["dvr_files_path"] ?: false;
            ...
            public function cron($part) {
                if ($part == 'daily') {
                    $dvrFileTtl = @$this->config["backends"]["dvrExports"]["dvr_files_ttl"];
                    $currentTime = time();
                    $dvrExportsFolder = @$this->config["backends"]["dvrExports"]["dvr_files_path"];
