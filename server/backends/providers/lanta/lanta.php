    ...
    namespace backends\providers
    {
        ...
        class lanta extends providers
        {
            ...
            function putSecrets($section, $secrets) {
                ...
                curl_setopt($curl, CURLOPT_URL, $this->config["backends"]["providers"]["providers.api"] . "?action=secrets&secrets=" . $section . "&secret=" . $this->config["backends"]["providers"]["control_secret"]);
