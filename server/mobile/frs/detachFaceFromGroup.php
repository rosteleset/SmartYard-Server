...
/**
 * @api {post} /mobile/frs/detachFaceFromGroup detach the face from the subscriber's group
 * @apiVersion 1.0.0
 ...
 * 417 Failed to detach the face from the group
...
$r = $frs->detachFaceFromGroupFrs($face_id, $group_id);
if ($r === true) {
    response(204);
} else {
    response(417 , false, i18n("mobile.error"), i18n("mobile.cantDetachFaceFromGroup"));
}
