CREATE TABLE core_users_tokens(uid integer not null, token TEXT);
...
CREATE TABLE core_users_notifications(notification_id integer primary key autoincrement, uid integer, created integer, sended integer, delivered integer, readed integer, caption text, body text, data text);
