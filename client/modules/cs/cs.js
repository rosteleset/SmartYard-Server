    ...
    renderCS: function (silent) {
        ...
        function loadSheet() {
            ...
            fail(loadingDone).
                ...
                rtd += `<div class="input-group input-group-sm mr-2" style="width: 200px;"><div class="input-group-prepend"><span class="input-group-text pointer-input-group" title="${i18n("cs.refresh")}" id="csRefresh"><i class="fas fa-fw fa-sync-alt"></i></span></div><select id="csSheet" class="form-control select-arrow">${sheetsOptions}</select></div>`;
