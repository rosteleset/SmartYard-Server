                        ...
                        QUERY("subscribers", "searchRf", {
                            ...
                            if (ss && ss.subscribers && ss.subscribers.length) {
                                ...
                                for (let i in ss.subscribers) {
                                    ...
                                    h += `<a href="javascript:void(0)" class="ss" data-subscriber-id="${i}">#${ss.subscribers[i].subscriberId} ${ss.subscribers[i].subscriberFull ? ss.subscribers[i].subscriberFull : i18n("addresses.undefined")}</a><br />`;

                                    h += '<div class="mt-1">';
                                    h += '<i class="fas fa-fw fa-mobile mr-2 ml-4"></i>';
                                    h += `<a href='?#addresses.subscriberDevices&subscriberId=${ss.subscribers[i].subscriberId}&phone=${ss.subscribers[i].mobile}'>${i18n("addresses.devices")}</a><br />`;
                                    h += '</div>';
