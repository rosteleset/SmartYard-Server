            ...
            cardForm({
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        hidden: parseInt(response.user.twoFA),
                        tab: i18n("users.2fa"),
                    },
                    {
                        id: "2faSecret",
                ...
                cardTable({
                    ...
                    rows: () => {
                        ...
                        for (let i = 0; i < response.users.length; i++) {
                            ...
                            cl = (response.users[i].enabled == 1) ? cl : "bg-light text-decoration-line-through";
