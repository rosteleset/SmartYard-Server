({
    ...
    menu: {
        ...
        items: [
            ...
            },
            {
                ...
                text: i18n("mkb.addDesk"),
            },
            {
                id: "mkbEditDesk",
                icon: "far fa-edit",
                text: i18n("mkb.editDesk"),
            },
            {
                id: "mkbDeleteDesk",
                icon: "far fa-minus-square",
                text: i18n("mkb.deleteDesk"),
            },
        ],
        click: (id) => {
            switch (id) {
                ...
                case "mkbEditDesk":
                    modules.mkb.editDesk();
                    break;

                case "mkbDeleteDesk":
                    modules.mkb.deleteDesk();
                    break;
            }
        },
    },
    ...
    assignHandlers: function () {
        ...
        $(".cardSend").off("click").on("click", function () {
            modules.mkb.cardSend($(this).attr("data-card-id"));
        });
            ...
            <div id="card-${card._id}" data-card-id="${card._id}" class="kanban-card card card-${card.color} card-outline" style="${(modules.mkb.tags.length && !v) ? "display: none;" : ""}">
                <div class="card-header card-handle pl-1 pr-3">
                    ...
                    <div class="card-tools">
                        ...
                        <span class="btn btn-tool cardSend pr-0" title="${i18n("mkb.send")}" data-card-id="${card._id}" style="display: none;"><i class="far fa-fw fa-share-from-square "></i></span>
