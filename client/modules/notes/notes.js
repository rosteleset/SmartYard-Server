    ...
    colors: [
        {
            ...
            value: "white",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-white",
        },
        {
            text: i18n("notes.coral"),
            value: "coral",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-coral",
        },
        {
            text: i18n("notes.peach"),
            value: "peach",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-peach",
        },
        {
            text: i18n("notes.sand"),
            value: "sand",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-sand",
        },
        {
            text: i18n("notes.mint"),
            value: "mint",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-mint",
        },
        {
            text: i18n("notes.grayGreen"),
            value: "grayGreen",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-grayGreen",
        },
        {
            text: i18n("notes.grayBlue"),
            value: "grayBlue",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-grayBlue",
        },
        {
            text: i18n("notes.gray"),
            value: "gray",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-gray",
        },
        {
            text: i18n("notes.darkBlue"),
            value: "darkBlue",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-darkBlue",
        },
        {
            text: i18n("notes.pink"),
            value: "pink",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-pink",
        },
        {
            text: i18n("notes.terracotta"),
            value: "terracotta",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-terracotta",
        },
        {
            text: i18n("notes.lightGray"),
            value: "lightGray",
            icon: "p-1 fas fa-fw width32 fa-palette sticky-bg-color-lightGray",
        },
    ],
